...
1.  **Clone the Repository:**
    ...
    ```
2.  **Open the Report:**
    - Launch `Credit_Card_Report.pbix` in Power BI Desktop.
    - If the data source path is different, go to **Transform Data > Data Source Settings** and point to the `data/credit_card.csv` file included in this repo.

---
*Designed & Developed by Atharva Kadam*
